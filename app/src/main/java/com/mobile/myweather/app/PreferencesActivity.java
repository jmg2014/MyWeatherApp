...
public class PreferencesActivity extends PreferenceActivity  implements Preference.OnPreferenceChangeListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        getFragmentManager().executePendingTransactions();//In order to avoid  null

        Preference preference =  prefsFragment.findPreference(getString(R.string.pref_location_key));
